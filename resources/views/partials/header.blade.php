            ...
            <div class="row align-items-center">
                ...
                <div class="col text-center header-top-center">
                    <div class="header-top-message text-upper">
                        <span>Temukan</span>Kualitas barang terbaik di sini!
                    </div>
                </div>
                ...
                <div class="col-md-12 align-self-center">
                    <div class="ec-main-menu">
                        <ul>
                            ...
                            <li class="dropdown"><a href="javascript:void(0)">Produk</a></li>
                            <li class="dropdown"><a href="javascript:void(0)">Kategori</a>
                                <ul class="sub-menu">
                                    <li><a href="about-us.html">Alumunium</a></li>
                                    <li><a href="contact-us.html">Atap</a></li>
                                </ul>
                            </li>
                            <li class="dropdown"><a href="javascript:void(0)">Artikel</a></li>
