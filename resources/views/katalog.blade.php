                    ...
                    <div class="ec-multi-vendor-detail">
                        <div class="ec-page-description ec-page-description-info">
                            <div class="ec-catalog-vendor">
                                <img src="{{asset('tlandingPage/assets/images/vendor/1.jpg')}}" alt="vendor img">
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="ec-multi-vendor-detail">
                        <div class="ec-page-description ec-page-description-info">
                            <div class="ec-catalog-vendor">
                                <img src="{{asset('tlandingPage/assets/images/vendor/2.jpg')}}" alt="vendor img">
                            </div>
                            <div class="ec-catalog-vendor-info">
                                <div class="row vendor-card-height">
                                    <div class="col-lg-3 col-md-6 detail-card-space">
            ...
            <div class="container">
                <div class="row">
                    <div class="ec-multi-vendor-detail">
                        <div class="ec-page-description ec-page-description-info">
                            <div class="ec-catalog-vendor">
                                <img src="{{asset('tlandingPage/assets/images/vendor/3.jpg')}}" alt="vendor img">
                            </div>
                            <div class="ec-catalog-vendor-info">
                                <div class="row vendor-card-height">
                                    <div class="col-lg-3 col-md-6 detail-card-space">
            ...
            <div class="container">
                <div class="row">
                    <div class="ec-multi-vendor-detail">
                        <div class="ec-page-description ec-page-description-info">
                            <div class="ec-catalog-vendor">
                                <img src="{{asset('tlandingPage/assets/images/vendor/4.jpg')}}" alt="vendor img">
                            </div>
                            <div class="ec-catalog-vendor-info">
                                <div class="row vendor-card-height">
                                    <div class="col-lg-3 col-md-6 detail-card-space">
            ...
            <div class="container">
                <div class="row">
                    <div class="ec-multi-vendor-detail">
                        <div class="ec-page-description ec-page-description-info">
                            <div class="ec-catalog-vendor">
                                <img src="{{asset('tlandingPage/assets/images/vendor/5.jpg')}}" alt="vendor img">
                            </div>
                            <div class="ec-catalog-vendor-info">
                                <div class="row vendor-card-height">
                                    <div class="col-lg-3 col-md-6 detail-card-space">
