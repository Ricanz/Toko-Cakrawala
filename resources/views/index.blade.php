                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/3_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/3_2.jpg')}}" alt="Product" />
                                                </a>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/3_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/3_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#75e3ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/3_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/3_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#11f7d8;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/3_3.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/3_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#acff7c;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/3_5.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/3_5.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/4_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/4_2.jpg')}}" alt="Product" />
                                                </a>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                                    title="Quick view" data-bs-toggle="modal"
                                                    data-bs-target="#ec_quickview_modal"><img
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/4_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/4_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#ebbf60;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/4_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/4_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#b4fc57;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/4_3.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/4_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#2ea1cd;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/4_4.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/4_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/5_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/5_2.jpg')}}" alt="Product" />
                                                </a>
                                                <span class="flags">
                                                    <span class="new">New</span>
                                                </span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/5_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/5_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#9e9e9e;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/5_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/5_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/8_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/8_2.jpg')}}" alt="Product" />
                                                </a>
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/10_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/10_2.jpg')}}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/10_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/10_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#41d49c;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/10_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/10_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#fc8484;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/10_3.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/10_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#db94f7;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/10_4.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/10_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/9_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/9_2.jpg')}}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/9_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/9_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#21b7fc;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/9_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/9_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#1df0ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/9_3.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/9_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/11_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/11_2.jpg')}}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="new">New</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/11_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/11_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#dba4ff;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/11_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/11_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#ff4a77;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/11_3.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/11_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#c9ff55;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/11_4.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/11_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/12_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/12_2.jpg')}}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/12_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/12_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#db9dff;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/12_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/12_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#00ffff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/12_3.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/12_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ffa7f3;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/12_4.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/12_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/13_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/13_2.jpg')}}" alt="Product" />
                                                </a>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                                    title="Quick view" data-bs-toggle="modal"
                                                    data-bs-target="#ec_quickview_modal"><img
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/13_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/13_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#deffa4;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/13_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/13_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#ffcdbe;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/13_3.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/13_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ff94df;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/13_4.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/13_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/14_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/14_2.jpg')}}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                                    title="Quick view" data-bs-toggle="modal"
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#"
                                                                ...
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/14_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/14_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#bb8641;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/14_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/14_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#5dd677;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="tlandingpage/assets/images/product-image/14_3.jpg"
                                                                data-src-hover="tlandingpage/assets/images/product-image/14_3.jpg"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#32ffdd;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="tlandingpage/assets/images/product-image/14_4.jpg"
                                                                data-src-hover="tlandingpage/assets/images/product-image/14_4.jpg"
                                                                data-tooltip="Sky Blue"><span
                                                ...
                                                <div class="ec-pro-size">
                                                    ...
                                                    <ul class="ec-opt-size">
                                                        <li class="active"><a href="#"
                                                                class="ec-opt-sz" data-old="$70.00"
                                                                data-new="$60.00" data-tooltip="Small">6</a></li>
                                                        <li><a href="#" class="ec-opt-sz" data-old="$80.00"
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                ...
                                                <div class="ec-pro-size">
                                                    ...
                                                    <ul class="ec-opt-size">
                                                        <li class="active"><a href="#"
                                                                class="ec-opt-sz" data-old="$40.00"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/15_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/15_2.jpg')}}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#"
                                                                class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/15_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/15_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#ffacfb;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/15_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/15_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#90dfff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/15_3.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/15_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#c6ff4a;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/15_4.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/15_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                                ...
                                                <div class="ec-pro-size">
                                                    ...
                                                    <ul class="ec-opt-size">
                                                        <li class="active"><a href="#"
                                                                class="ec-opt-sz" data-old="$80.00"
                                                                data-new="$70.00" data-tooltip="Small">4</a></li>
                                                        <li><a href="#" class="ec-opt-sz" data-old="$70.00"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/16_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/16_2.jpg')}}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="new">New</span>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#"
                                                                class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/16_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/16_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#6ee9ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/16_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/16_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#eb99ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/16_3.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/16_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ff6464;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/16_4.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/16_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/17_1.jpg')}}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{asset('tlandingpage/assets/images/product-image/17_2.jpg')}}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#"
                                                                class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/17_1.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/17_1.jpg')}}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#8ad2fc;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/17_2.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/17_2.jpg')}}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#ff8ef6;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/17_3.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/17_3.jpg')}}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ffbe31;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{asset('tlandingpage/assets/images/product-image/17_4.jpg')}}"
                                                                data-src-hover="{{asset('tlandingpage/assets/images/product-image/17_4.jpg')}}"
                                                                data-tooltip="Sky Blue"><span
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                ...
                                                <div class="ec-pro-size">
                                                    ...
                                                    <ul class="ec-opt-size">
                                                        <li class="active"><a href="#"
                                                                class="ec-opt-sz" data-old="$30.00"
                                                                data-new="$25.00" data-tooltip="Small">S</a></li>
                                                        <li><a href="#" class="ec-opt-sz" data-old="$35.00"
                                                                data-new="$27.00" data-tooltip="Medium">M</a></li>
                                                        <li><a href="#" class="ec-opt-sz" data-old="$40.00"
                                                                data-new="$30.00" data-tooltip="Large">X</a></li>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                ...
                                                <div class="ec-pro-size">
                                                    ...
                                                    <ul class="ec-opt-size">
                                                        <li class="active"><a href="#"
                                                                class="ec-opt-sz" data-old="$25.00"
                    ...
                    <div class="row">
                        <div class="banner-block col-lg-6 col-md-12 margin-b-30" data-animation="slideInRight">
                            <div class="bnr-overlay">
                                <img src="{{asset('tlandingpage/assets/images/banner/2.jpg')}}" alt="" />
                        ...
                        <div class="banner-block col-lg-6 col-md-12" data-animation="slideInLeft">
                            <div class="bnr-overlay">
                                <img src="{{asset('tlandingpage/assets/images/banner/3.jpg')}}" alt="" />
                                <div class="banner-text">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <ul class="ec-cat-tab-nav nav">
                        <li class="cat-item"><a class="cat-link active" data-bs-toggle="tab"
                                href="#tab-cat-1">
                                <div class="cat-icons"><img class="cat-icon"
                                        src="{{asset('tlandingpage/assets/images/icons/cat_1.png')}}" alt="cat-icon"><img class="cat-icon-hover"
                                        src="{{asset('tlandingpage/assets/images/icons/cat_1_1.png')}}" alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-2">
                                <div class="cat-icons"><img class="cat-icon"
                                        src="{{asset('tlandingpage/assets/images/icons/cat_2.png')}}" alt="cat-icon"><img class="cat-icon-hover"
                                        src="{{asset('tlandingpage/assets/images/icons/cat_2_1.png')}}" alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-3">
                                <div class="cat-icons"><img class="cat-icon"
                                        src="{{asset('tlandingpage/assets/images/icons/cat_3.png')}}" alt="cat-icon"><img class="cat-icon-hover"
                                        src="{{asset('tlandingpage/assets/images/icons/cat_3_1.png')}}" alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-4">
                                <div class="cat-icons"><img class="cat-icon"
                                        src="{{asset('tlandingpage/assets/images/icons/cat_4.png')}}" alt="cat-icon"><img class="cat-icon-hover"
                                        src="{{asset('tlandingpage/assets/images/icons/cat_4_1.png')}}" alt="cat-icon"></div>
                ...
                <div class="col-lg-9">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="tab-cat-1">
                            <div class="row">
                                <img src="tlandingpage/assets/images/cat-banner/1.jpg" alt="" />
                            </div>
                        ...
                        <div class="tab-pane fade" id="tab-cat-2">
                            <div class="row">
                                <img src="tlandingpage/assets/images/cat-banner/2.jpg" alt="" />
                            </div>
                            <span class="panel-overlay">
                                <a href="shop-left-sidebar-col-3.html" class="btn btn-primary">View All</a>
                            </span>
                        ...
                        <div class="tab-pane fade" id="tab-cat-3">
                            <div class="row">
                                <img src="tlandingpage/assets/images/cat-banner/3.jpg" alt="" />
                            </div>
                            <span class="panel-overlay">
                                <a href="shop-left-sidebar-col-3.html" class="btn btn-primary">View All</a>
                            </span>
                        ...
                        <div class="tab-pane fade" id="tab-cat-4">
                            <div class="row">
                                <img src="tlandingpage/assets/images/cat-banner/4.jpg" alt="" />
                            </div>
                            <span class="panel-overlay">
                                <a href="shop-left-sidebar-col-3.html" class="btn btn-primary">View All</a>
                            </span>
                                ...
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="product-left-sidebar.html" class="image"><img
                                                class="main-image" src="{{asset('tlandingpage/assets/images/product-image/1_1.jpg')}}"
                                                alt="Product" /></a>
                                        <a href="#" class="quickview" data-link-action="quickview"
                                            title="Quick view" data-bs-toggle="modal"
                                            data-bs-target="#ec_quickview_modal"><img
                        ...
                        <div class="ec-fs-product">
                            <div class="ec-fs-pro-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="product-left-sidebar.html" class="image"><img
                                                class="main-image" src="{{asset('tlandingpage/assets/images/product-image/3_1.jpg')}}"
                                                alt="Product" /></a>
                                        <a href="#" class="quickview" data-link-action="quickview"
                                            title="Quick view" data-bs-toggle="modal"
                                            data-bs-target="#ec_quickview_modal"><img
                        ...
                        <div class="ec-fs-product">
                            <div class="ec-fs-pro-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="product-left-sidebar.html" class="image"><img
                                                class="main-image" src="{{asset('tlandingpage/assets/images/product-image/8_1.jpg')}}"
                                                alt="Product" /></a>
                                        <a href="#" class="quickview" data-link-action="quickview"
                                            title="Quick view" data-bs-toggle="modal"
                                            data-bs-target="#ec_quickview_modal"><img
                        ...
                        <div class="ec-fs-product">
                            <div class="ec-fs-pro-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="product-left-sidebar.html" class="image"><img
                                                class="main-image" src="{{asset('tlandingpage/assets/images/product-image/10_1.jpg')}}"
                                                alt="Product" /></a>
                                        <a href="#" class="quickview" data-link-action="quickview"
                                            title="Quick view" data-bs-toggle="modal"
                                            data-bs-target="#ec_quickview_modal"><img
            ...
            <div class="row margin-minus-t-15 margin-minus-b-15">
                    ...
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="tlandingpage/assets/images/vendor/2.jpg" alt="vendor img">
                            </div>
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/1_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/2_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/3_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/4_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="tlandingpage/assets/images/vendor/3.jpg" alt="vendor img">
                            </div>
                            <div class="ec-vendor-info">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/5_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/6_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/7_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/8_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="tlandingpage/assets/images/vendor/4.jpg" alt="vendor img">
                            </div>
                            <div class="ec-vendor-info">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/9_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/10_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/11_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/12_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="tlandingpage/assets/images/vendor/5.jpg" alt="vendor img">
                            </div>
                            <div class="ec-vendor-info">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/13_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/14_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/15_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{asset('tlandingpage/assets/images/product-image/16_1.jpg')}}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="ec_ser_content ec_ser_content_1 col-sm-12 col-md-6 col-lg-3" data-animation="zoomIn">
                    <div class="ec_ser_inner">
                        <div class="ec-service-image">
                            <img src="tlandingpage/assets/images/icons/service_1.svg" class="svg_img" alt="" />
                        </div>
                ...
                <div class="ec_ser_content ec_ser_content_2 col-sm-12 col-md-6 col-lg-3" data-animation="zoomIn">
                    <div class="ec_ser_inner">
                        <div class="ec-service-image">
                            <img src="tlandingpage/assets/images/icons/service_2.svg" class="svg_img" alt="" />
                        </div>
                        <div class="ec-service-desc">
                            <h2>24X7 Support</h2>
                ...
                <div class="ec_ser_content ec_ser_content_3 col-sm-12 col-md-6 col-lg-3" data-animation="zoomIn">
                    <div class="ec_ser_inner">
                        <div class="ec-service-image">
                            <img src="tlandingpage/assets/images/icons/service_3.svg" class="svg_img" alt="" />
                        </div>
                        <div class="ec-service-desc">
                ...
                <div class="ec_ser_content ec_ser_content_4 col-sm-12 col-md-6 col-lg-3" data-animation="zoomIn">
                    <div class="ec_ser_inner">
                        <div class="ec-service-image">
                            <img src="tlandingpage/assets/images/icons/service_4.svg" class="svg_img" alt="" />
                        </div>
                        <div class="ec-service-desc">
        ...
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center ec-offer-content">
                    ...
                    <span class="ec-offer-img" data-animation="zoomIn"><img src="tlandingpage/assets/images/offer-image/1.png"
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{asset('tlandingpage/assets/images/product-image/9_1.jpg')}}"
                                        alt="Product" />
                                    <img class="hover-image" src="{{asset('tlandingpage/assets/images/product-image/9_2.jpg')}}"
                                        alt="Product" />
                                </a>
                                <span class="flags">
                                    <span class="sale">Sale</span>
                                ...
                                <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                    data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img
                                        src="{{asset('tlandingpage/assets/images/icons/quickview.svg')}}" class="svg_img pro_svg" alt="" /></a>
                                <div class="ec-pro-actions">
                                    <a href="compare.html" class="ec-btn-group compare" title="Compare"><img
                                            src="{{asset('tlandingpage/assets/images/icons/compare.svg')}}" class="svg_img pro_svg"
                                            alt="" /></a>
                                    <button title="Add To Cart" class="add-to-cart"><img
                                            src="{{asset('tlandingpage/assets/images/icons/cart.svg')}}" class="svg_img pro_svg" alt="" /> Add
                                        To
                                        Cart</button>
                                    <a class="ec-btn-group wishlist" title="Wishlist"><img
                                            src="{{asset('tlandingpage/assets/images/icons/wishlist.svg')}}" class="svg_img pro_svg"
                                            alt="" /></a>
                                </div>
                            </div>
                        </div>
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-option">
                                ...
                                <div class="ec-pro-size">
                                    ...
                                    <ul class="ec-opt-size">
                                        <li class="active"><a href="#" class="ec-opt-sz"
                                                data-old="$20.00" data-new="$15.00" data-tooltip="Small">S</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{asset('tlandingpage/assets/images/product-image/11_1.jpg')}}"
                                        alt="Product" />
                                    <img class="hover-image" src="{{asset('tlandingpage/assets/images/product-image/11_2.jpg')}}"
                                        alt="Product" />
                                </a>
                                <span class="flags">
                                    <span class="new">New</span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{asset('tlandingpage/assets/images/product-image/12_1.jpg')}}"
                                        alt="Product" />
                                    <img class="hover-image" src="{{asset('tlandingpage/assets/images/product-image/12_2.jpg')}}"
                                        alt="Product" />
                                </a>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Fancy Ladies Sandal</a>
                            </h5>
                            <div class="ec-pro-rating">
                                <i class="ecicon eci-star fill"></i>
                                <i class="ecicon eci-star fill"></i>
                            ...
                            <div class="ec-pro-option">
                                ...
                                <div class="ec-pro-size">
                                    ...
                                    <ul class="ec-opt-size">
                                        <li class="active"><a href="#" class="ec-opt-sz"
                                                data-old="$50.00" data-new="$40.00" data-tooltip="Small">6</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{asset('tlandingpage/assets/images/product-image/13_1.jpg')}}"
                                        alt="Product" />
                                    <img class="hover-image" src="{{asset('tlandingpage/assets/images/product-image/13_2.jpg')}}"
                                        alt="Product" />
                                </a>
                                <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                    data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img
                ...
                <div class="ec-test-outer">
                    <ul id="ec-testimonial-slider">
                        <li class="ec-test-item">
                            <img src="tlandingpage/assets/images/testimonial/top-quotes.svg" class="svg_img test_svg top" alt="" />
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="tlandingpage/assets/images/testimonial/1.jpg" /></div>
                            ...
                            <img src="tlandingpage/assets/images/testimonial/bottom-quotes.svg" class="svg_img test_svg bottom"
                                alt="" />
                        </li>
                        <li class="ec-test-item ">
                            <img src="tlandingpage/assets/images/testimonial/top-quotes.svg" class="svg_img test_svg top" alt="" />
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="tlandingpage/assets/images/testimonial/2.jpg" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc">Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                        ever since the 1500s, when an unknown printer took a galley of type and
                        ...
                        <li class="ec-test-item">
                            ...
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="tlandingpage/assets/images/testimonial/3.jpg" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc">Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                        ever since the 1500s, when an unknown printer took a galley of type and
                    ...
                    <ul id="ec-brand-slider">
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="tlandingpage/assets/images/brand-image/1.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="tlandingpage/assets/images/brand-image/2.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="tlandingpage/assets/images/brand-image/3.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="tlandingpage/assets/images/brand-image/4.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="tlandingpage/assets/images/brand-image/5.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="tlandingpage/assets/images/brand-image/6.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="tlandingpage/assets/images/brand-image/7.png" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="tlandingpage/assets/images/brand-image/8.png" /></a></div>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="insta-auto">
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="tlandingpage/assets/images/instragram-image/1.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="tlandingpage/assets/images/instragram-image/2.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="tlandingpage/assets/images/instragram-image/3.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="tlandingpage/assets/images/instragram-image/4.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="tlandingpage/assets/images/instragram-image/5.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="tlandingpage/assets/images/instragram-image/6.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="tlandingpage/assets/images/instragram-image/7.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
