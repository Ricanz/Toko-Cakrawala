                                                        ...
                                                        <table class="table ec-table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"><span>$130</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <th><span>548</span></th>
                                                                    ...
                                                                    <td class="text-center"><span>$30</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <th><span>684</span></th>
                                                                    <td><span>Baby clothes pair</span></td>
                                                                    <td class="text-center"><span>1</span></td>
                                                                    <td class="text-center"><span>$360</span></td>
                                                                    <td class="text-center"><span>$360</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <th><span>987</span></th>
                                                                    ...
                                                                    <td class="text-center"><span>$250</span></td>
                                                                </tr>
                                                            </tbody>
                                                            <tfoot>
                                                                <tr>
                                                                    ...
                                                                    <td class="border-color m-m15 text-center text-600 text-90"
                                                                        colspan="1"><h5><strong>Total</strong></h5>
                                                                    </td>
                                                                    <td class="border-color m-m15 text-center text-600 text-90">
                                                                        <h5>$3872</h5></td>
                                                                </tr>
